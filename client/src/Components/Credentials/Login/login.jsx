    ...
    for (i of ErrorContainer) {
      if (i.error_type === "Username") {
        ...
        if (UsernameRef && PasswordRef) {
          ...
          PasswordRef.current.style.border = "1px solid red";
          invalid_cred = (
            <div className="invalid-cred-error">Invalid Credentials</div>
          );
        }
      }
    }
          ...
          <main className="signup-input-container">
            ...
            <div className="signup-input-rel">
              <input
                ...
                onChange={Context.ChangeSigninUsername}
                value={Context.signin_username}
                ref={UsernameRef}
              />
            </div>
            {username_error}
            ...
            <div className="signup-input-rel">
              <input
                type="password"
                className="signup-input"
                onChange={Context.ChangeSigninPassword}
                value={Context.signin_password}
                ref={PasswordRef}
              />
            </div>
            {password_error}
